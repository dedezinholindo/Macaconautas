...
public class StoreBuilder {
	...
	private final static String SKIN_OPTIONS[] = {"Macaco", "Macaco 47", "Mico Leão Dourado", "Ninjacaco", "Macaconauta"};
	private final static int SKIN_PRICES[] = {0, 2, 4, 7, 15};
	...
	public StoreBuilder(SpriteSheet spriteSheet, boolean ownedSkins[], int selectedSkin, int bananaQuantity) {
		this.state = 'N';
		this.isRunning = true;
